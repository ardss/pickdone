  ...
  <div class="pd-view-page today-v1">
    <div class="today-body">
      ...
      <div class="today-main">
        ...
        <div v-if="viewMode==='matrix'" class="today-list"><pd-matrix-grid :tasks="matrixTasks"/></div>
...
export default {
  name: 'TodayView',
  components: { TodoGroups, DayDateStrip, PdMatrixGrid: MatrixGrid, PdDayDeck: DayDeck, DayRail },
  data () {
    ...
    const mode = ['list', 'matrix', 'deck'].includes(saved) ? saved : (this.$route.query.matrix ? 'matrix' : 'list')
