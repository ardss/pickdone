/**
 * Statutory holiday data (single source, dw wave5 2026-09-24) — consumed by the renderer
 * (static import via renderer/js/utils/holidays.js), the main process and the CLI (require(esm),
 * Node >= 22.12 / Electron 39 — same pattern as shared/limits.mjs). The two former hand-rolled
 * mirrors (renderer/js/utils/holidays.js, src/main/core/holidays.js) were verbatim copies that
 * had to be updated in sync every year around Oct–Nov.
